            ...
            <div class="multisteps-form mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <form class="multisteps-form__form mb-8" action="{{ route('manufacturer.update',$manufacturerModel) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active"
                                ...
                                <div class="multisteps-form__content">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                            <label>Email</label>
                                            <input class="multisteps-form__input form-control" type="text" placeholder="eg. Michael@gmail.com" name="email" value="{{ $manufacturerModel->email  ?? old('email')}}">
                                            @error('email')
                                                <div class="alert alert-danger alert-dismissible text-white p-1 mt-3" role="alert">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6  mt-3 mt-sm-0">
                                            <label>Address</label>
                                            <input class="form-control" type="text" placeholder="Ho Chi Minh city" name="address" value="{{ $manufacturerModel->address  ?? old('address')}}">
                                            @error('address')
                                                <div class="alert alert-danger alert-dismissible text-white p-1 mt-3" role="alert">
                                                    {{ $message }}
                                                </div>
