            ...
            <div class="multisteps-form mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <form class="multisteps-form__form mb-8" action="{{ route('medicine.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                                ...
                                <div class="multisteps-form__content">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 col-sm-6  mt-3 mt-sm-0">
                                            <label>Root</label>
                                            <input  class="form-control" type="text" placeholder="VietNam" name="root">
                                            @error('root')
                                                <div class="alert alert-danger alert-dismissible text-white p-1 mt-3" role="alert">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input class="multisteps-form__input form-control" type="number" placeholder="eg. 20" name="quantity">
                                            @error('quantity')
                                                <div class="alert alert-danger alert-dismissible text-white p-1 mt-3" role="alert">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6  mt-3 mt-sm-0">
                                            <label>Price</label>
                                            <input class="form-control" type="text" placeholder="100.000VNĐ" name="price">
                                            @error('price')
                                                <div class="alert alert-danger alert-dismissible text-white p-1 mt-3" role="alert">
                                                    {{ $message }}
                                                </div>
