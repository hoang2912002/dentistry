                                        ...
                                        <table id="dataTable" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Root</th>
                                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Type_of_medicine</th>
        ...
        @push('js')
            <script>
                var columns = [{
                    ...
                    {
                        data: 'type_of_medicine_name',
                        name: 'type_of_medicine_name'
                    },
                    {
