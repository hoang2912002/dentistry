            ...
            <div class="multisteps-form mb-5">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 m-auto">
                        <form class="multisteps-form__form mb-8" action="{{ route('shift.update',$shiftModel) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="multisteps-form__content">
                                    <div class="row mt-3">
                                        <div class="col-12 col-sm-12">
                                            <label>Name</label>
                                            <input class="multisteps-form__input form-control" type="text" placeholder="eg. Admin" name="name" value="{{ $shiftModel->name  ?? old('name')}}">
                                            @error('name')
